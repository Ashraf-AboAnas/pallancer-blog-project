...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="{{route('welcome')}}">Cms<i>blog</i>.</a>
   					...
   					<div class="case">
   						<div class="row">
   							<div class="col-md-6 col-lg-6 col-xl-8 d-flex">
   								<a href="{{route('singlepage',$posts->id)}}" class="img w-100 mb-3 mb-md-0 " style="background-image: url({{asset('images/'. $posts->image) }}); " ></a>
   							</div>
   							<div class="col-md-6 col-lg-6 col-xl-4 d-flex">
   								<div class="text w-100 pl-md-3">
   									<span class="subheading">{{$posts->cat_name}}</span>
   									<h2><a href="{{route('singlepage',$posts->id)}}">{{$posts->title}}</a></h2>
			                ...
			                <li class="ftco-animate"><a href="#"><span class="icon-instagram"></span></a></li>
   									...
   									<div class="meta">
                                       <p class="mb-0"><a href="#">{{$posts->created_at}} |   {{$posts->created_at->diffForHumans()}}</a> </p>
