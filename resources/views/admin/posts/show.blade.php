...
<html lang="en">
  ...
  <body>
    ...
    style="background-image: url({{ asset('images/'. $posts->image) }});"
    data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
          <h2 class="mb-3 bread" style="color:white;font-size:46px;">{{$posts->title}}</h2>
   ...
   <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
          ...
          <p style="color:black;font-size:23px;">  {{$posts->content}} </p>
          ...
          <div class="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                ...
                <li><a href="#">{{$categories->name_an}} <span class="ion-ios-arrow-forward"></span></a></li>
                @endforeach
